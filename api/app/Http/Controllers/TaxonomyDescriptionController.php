...
class TaxonomyDescriptionController extends Controller
{
	 ...
	 * )
	 */
	public function showAllDescriptions($identifier, Request $request)
	{
		...
		$inventoryQuery = TaxonomyDescription::where('taxonomy_id', $identifier);
	 ...
	 * )
	 */
	public function showOneDescriptions($identifier, $description_id)
	{
		$inventoryObj = TaxonomyDescription::where('taxonomy_id', $identifier)
