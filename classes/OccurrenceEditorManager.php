...
class OccurrenceEditorManager {
	...
	private function encodeStrTargeted($inStr, $inCharset, $outCharset){
		...
		$retStr = $inStr;
		$retStr = mb_convert_encoding($retStr, $outCharset, mb_detect_encoding($retStr, 'UTF-8,ISO-8859-1'));
		return $retStr;
	}
	...
	protected function encodeStr($inStr){
		$retStr = $inStr;
		if($inStr){
			$retStr = mb_convert_encoding($retStr, $GLOBALS['CHARSET'], mb_detect_encoding($retStr, 'UTF-8,ISO-8859-1'));
 		}
		return $retStr;
	}
