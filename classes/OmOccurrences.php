...
*/
   ...
   public function loadByDWCTriplet($institutionCode, $collectionCode, $catalogNumber) {
    ...
    if($institutionCode != NULL && $collectionCode !=NULL && $catalogNumber!=NULL) {
        ...
        geoWithin, highGeo, frequency, prepMethod, format, verbLat, verbLong, method, modified, dateLastModified, 
...
/*documentDate*/
  ...
  const C_storageLocationMYSQLI_TYPE='s';
   ...
   public function load($pk) {
        ...
        if($this->occid != NULL) {
            // input of the new quick entry form
           $preparesql = 'SELECT barcode, barcode, accesNum, fieldUnder, currName, idQualifier, detText, provenance, container, collTrip, geoWithin, highGeo, frequency, prepMethod, format, verbLat, verbLong, method, modified, dateLastModified, 
   ...
   public function save() {
        ...
        if ($this->occid!= NULL) {
            ...
            $isInsert = true;
            // input of the new quick entry form
            $sql .= '( barcode, barcode, accesNum, fieldUnder, currName, idQualifier, detText, provenance, container, collTrip, geoWithin, highGeo, frequency, prepMethod, format, verbLat, verbLong, method, modified, dateLastModified, 
