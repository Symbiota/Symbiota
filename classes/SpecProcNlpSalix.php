...
//************************************************************************************************************************************
	...
	private function GetUTM($L,$Baker = false)
		...
		$LL = OccurrenceUtilities::parseVerbatimCoordinates($UTM,"UTM");
		if(count($LL) > 0)
			{
	...
	private function PregLatLong($Preg,$L,$OneLine="")
		...
		if($Found > 1)
			...
			$LL = OccurrenceUtilities::parseVerbatimCoordinates($VerbLatLong);
			if(count($LL) > 0)
				{
...
//************************************************************************************************************************************
	...
	private function GetElevation()
		...
		$El = OccurrenceUtilities::parseVerbatimElevation($TempString);
		$Found=false;
		//$this->printr($El,"El");
		if(isset($El['minelev']))
			{
...
//**********************************************************************************************************************************
	...
	private function DateFromOneLine($Field, $L,$Partial=false)
		...
		if($Found!== 0)
			...
			$FormattedDate = OccurrenceUtilities::formatDate($VDate);
			if($FormattedDate != "")
				{
