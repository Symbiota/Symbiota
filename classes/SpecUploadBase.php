		...
		if($this->collId){
			if($this->uploadType == $this->FILEUPLOAD || $this->uploadType == $this->SKELETAL || $this->uploadType == $this->INATURALIST){
				...
				$sql = 'UPDATE IGNORE uploadspectemp u INNER JOIN omoccurrences o ON u.occid = o.occid
					...
					SET d.sciname = IFNULL(NULLIF(o.sciname, ""), "undetermined"), d.identifiedBy = IFNULL(NULLIF(o.identifiedBy, ""), "unknown"), d.dateIdentified = IFNULL(NULLIF(o.dateIdentified, ""), "s.d."),
				...
				$sql = 'INSERT IGNORE INTO omoccurdeterminations(occid, sciname, identifiedBy, dateIdentified, family, scientificNameAuthorship, tidInterpreted, identificationQualifier,
					...
					SELECT o.occid, IFNULL(NULLIF(o.sciname, ""), "undetermined") AS sciname, IFNULL(NULLIF(o.identifiedBy, ""), "unknown") AS identifiedBy, IFNULL(NULLIF(o.dateIdentified, ""), "s.d.") AS dateIdentified,
