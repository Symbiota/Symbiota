...
class TaxonomyHarvester extends Manager{
	...
	private function translateColApiNode($nodeArr){
		...
		if(isset($nodeArr['datasetKey'])) $taxonArr['source'] = '<a href="https://www.catalogueoflife.org/data/dataset/' . htmlspecialchars($nodeArr['datasetKey'], HTML_SPECIAL_CHARS_FLAGS) . '" target="_blank">https://www.catalogueoflife.org/data/dataset/' . htmlspecialchars($nodeArr['datasetKey'], HTML_SPECIAL_CHARS_FLAGS) . '</a>';
