...
if($crowdSourceMode){
	...
	$customFieldArr = array('associatedCollectors'=>$LANG['ASSOC_COLLECTORS'],'associatedOccurrences'=>$LANG['ASSOC_OCCS'],
			...
			'geodeticDatum'=>$LANG['GEO_DATUM'],'georeferenceProtocol'=>$LANG['GEO_PROTOCOL'],'georeferenceRemarks'=>$LANG['GEO_REMARKS'],'georeferenceSources'=>$LANG['GEO_SOURCES'],
	...
	$customPaleoFieldArr = array('absoluteAge'=>$LANG['ABS_AGE'],'bed'=>$LANG['BED'],'biostratigraphy'=>$LANG['BIOSTRAT'],'biota'=>$LANG['BIOTA'],'earlyInterval'=>$LANG['EARLY_INT'],
			'element'=>$LANG['ELEMENT'],'formation'=>$LANG['FORMATION'],'geologicalContextID'=>$LANG['GEO_CONTEXT_ID'],'lithogroup'=>$LANG['GROUP'],
			'lateInterval'=>$LANG['LATE_INT'],'lithology'=>$LANG['LITHOLOGY'],'localStage'=>$LANG['LOCAL_STAGE'],'member'=>$LANG['MEMBER'],
