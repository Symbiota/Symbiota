...
<head>
	...
	<script src="../js/symb/shared.js?ver=1e" type="text/javascript"></script>
	<style>
...
<body style="margin-left: 0px; margin-right: 0px;background-color:white;">
	...
	<div>
		<div style="width:65rem;margin-bottom:5px;">
			...
			<div id="sort-div" style="display:<?= ($sortField1?'block':'none') ?>;padding:5px;width:650px;">
				<section class="fieldset-like" style="margin:0px">
					...
					<form name="sortform" action="listtabledisplay.php" method="post">
						...
						<div>
							<label for="sortorder"> <b><?= $LANG['SORT_ORDER'] ?>:</b> </label>
