						...
						<section class="fieldset-like no-left-margin">
							...
							<ul>
								...
								<li>
									...
									<a id="importinfo" href="https://docs.symbiota.org/docs/Collection_Manager_Guide/Importing_Uploading/" title="<?php echo $LANG['MORE_INFO']; ?>" aria-label="<?php echo $LANG['MORE_INFO']; ?>">
