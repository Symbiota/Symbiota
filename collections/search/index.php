...
<head>
	...
	<script src="<?php echo $CLIENT_ROOT . '/js/symb/domManipulationUtils.js'; ?>" type="text/javascript"></script>
...
<script src="<?php echo $CLIENT_ROOT . '/js/symb/searchform.js?ver=2'; ?>" type="text/javascript"></script>
<script src="<?php echo $CLIENT_ROOT . '/js/alerts.js?v=202107'; ?>" type="text/javascript"></script>
