					...
					<div id="search-form-taxonomy" class="content">
						<div id="taxa-text" class="input-text-container">
							<label for="taxa" class="input-text--outlined">
								...
								<input type="text" name="taxa" id="taxa" data-chip="<?php echo $LANG['TAXA'] ?>">
							...
							<div id="bounding-box-form">
								...
								<div class="input-text-container">
										...
										<label for="upperlat_NS" class="input-text--outlined">
											<span class="skip-link"><?php echo $LANG['SELECT_UPPER_LAT_DIRECTION'] ?></span>
											<select class="mt-1" id="upperlat_NS" name="upperlat_NS">
												<option value=""><?php echo $LANG['SELECT_N_S'] ?></option>
												<option id="ulN" value="N"><?php echo $LANG['N'] ?></option>
												<option id="ulS" value="S"><?php echo $LANG['S'] ?></option>
											</select>
										</label>
								</div>
								<div class="input-text-container">
									...
									<label for="bottomlat_NS">
										<span class="skip-link"><?php echo $LANG['SELECT_BOTTOM_LAT_DIREC'] ?></span>
										<select class="mt-1" id="bottomlat_NS" name="bottomlat_NS">
											<option value=""><?php echo $LANG['SELECT_N_S'] ?></option>
											<option id="blN" value="N"><?php echo $LANG['N'] ?></option>
											<option id="blS" value="S"><?php echo $LANG['S'] ?></option>
										</select>
									</label>
								</div>
								<div class="input-text-container">
									...
									<label for="leftlong_EW" class="input-text--outlined">
										<span class="skip-link"><?php echo $LANG['SELECT_LEFT_LONG_DIREC_W_E'] ?></span>
										<select class="mt-1" id="leftlong_EW" name="leftlong_EW">
											<option value=""><?php echo $LANG['SELECT_W_E'] ?></option>
											<option id="llW" value="W"><?php echo $LANG['W'] ?></option>
											<option id="llE" value="E"><?php echo $LANG['E'] ?></option>
										</select>
									</label>
								</div>
								<div class="input-text-container">
									<label for="rightlong" class="input-text--outlined">
										...
										<label for="rightlong_EW" class="input-text--outlined">
											<span class="skip-link"><?php echo $LANG['SELECT_RIGHT_LONG_DIREC_W_E'] ?></span>
											<select class="mt-1" id="rightlong_EW" name="rightlong_EW">
												<option value=""><?php echo $LANG['SELECT_W_E'] ?></option>
												<option id="rlW" value="W"><?php echo $LANG['W'] ?></option>
												<option id="rlE" value="E"><?php echo $LANG['E'] ?></option>
											</select>
										</label>
								</div>
							</div>
							...
							<div id="point-radius-form">
								...
								<div class="input-text-container">
									...
									<label for="pointlat_NS" class="input-text--outlined">
										<span class="skip-link"><?php echo $LANG['POINT_LAT_DIREC_N_S'] ?></span>
										<select class="mt-1" id="pointlat_NS" name="pointlat_NS">
											<option value=""><?php echo $LANG['SELECT_N_S'] ?></option>
											<option id="N" value="N"><?php echo $LANG['N'] ?></option>
											<option id="S" value="S"><?php echo $LANG['S'] ?></option>
										</select>
									</label>
								</div>
								<div class="input-text-container">
									...
									<label for="pointlong_EW" class="input-text--outlined">
										...
										<select class="mt-1" id="pointlong_EW" name="pointlong_EW">
											...
											<option id="E" value="E"><?php echo $LANG['E'] ?></option>
										</select>
									</label>
								</div>
								<div class="input-text-container">
						...
						<div id="search-form-coll-event">
							...
							<div class="input-text-container">
								<label for="collnum" class="input-text--outlined">
									<span class="skip-link"><?php echo $LANG['COLLECTOR_NUMBER'] ?></span>
