...
<body>
	...
	<div role="main" id="innertext" class="inner-search" style="max-width: 1920px">
		<h1 class="page-heading"><?php echo $LANG['SAMPLE_SEARCH'] ?> <a href="https://biokic.github.io/symbiota-docs/user/search/" target="_blank" title="<?= $LANG['HOW_TO_SEARCH'] ?>"><img class="docimg" src="../../images/qmark.png" /></a></h1>
			...
			<div class="accordions">
				...
				?>
						<section>
							...
							<!-- Accordion header -->
							<label for="trait" class="accordion-header"><?php echo $LANG['TRAIT_CRITERIA'] ?> <a href="https://biokic.github.io/symbiota-docs/editor/trait/" target="_blank" title="<?= $LANG['MORE_INFO'] ?>"><img class="docimg" src="../../images/qmark.png" /></a></label>
							<!-- Accordion content -->
							<div class="content">
				...
				<section>
					...
					<!-- Accordion header -->
					<label for="associations" class="accordion-header"><?php echo $LANG['ASSOCIATIONS'] ?> <a href="https://biokic.github.io/symbiota-docs/user/search/associations/" target="_blank" title="<?= $LANG['MORE_INFO'] ?>"><img class="docimg" src="../../images/qmark.png" /></a></label>
