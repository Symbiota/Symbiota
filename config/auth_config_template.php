...
$CALLBACK_REDIRECT = 'https://' . $SERVER_HOST . $CLIENT_ROOT . '/profile/authCallback.php';
$LOGOUT_REDIRECT = 'https://' . $SERVER_HOST . $CLIENT_ROOT . '/profile/logout.php'; //@TODO add as auth provider's logout callback URL
