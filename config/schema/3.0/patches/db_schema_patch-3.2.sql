...
ALTER TABLE `taxa` 
  ADD COLUMN `sourceTaxonID` VARCHAR(45) NULL AFTER `source`;

ALTER TABLE `uploadspectemp` 
ADD COLUMN `taxonID` VARCHAR(45) NULL AFTER `tidinterpreted`,
ADD COLUMN `taxonConceptID` VARCHAR(45) NULL AFTER `taxonID`,
ADD COLUMN `identifiedByID` VARCHAR(45) NULL AFTER `identifiedBy`,
ADD COLUMN `identificationVerificationStatus` VARCHAR(45) NULL AFTER `identificationQualifier`;  
