...
session_start(array('gc_maxlifetime'=>3600,'cookie_path'=>$CLIENT_ROOT,'cookie_secure'=> getenv('APP_ENV') === 'testing'? false: ($GLOBALS['HTTPS_ONLY'] ?? true),'cookie_httponly'=>true, 'use_only_cookies' => true));
