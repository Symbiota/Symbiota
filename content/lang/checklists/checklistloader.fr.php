...
$LANG['RETURN_CHECKLIST'] = 'Retour à la liste de contrôle';
...
$LANG['NOTES'] = 'notes';
$LANG['INTERNALNOTES'] = 'notes internes';
$LANG['SOURCE'] = 'source';
$LANG['REQUIRED'] = '(obligatoire)';
$LANG['OPTIONAL'] = '(facultatif)';
$LANG['OPTIONAL_DISP'] = '(facultatif) - affiché uniquement pour les éditeurs';
$LANG['NO_RIGHTS'] = 'Vous ne semblez pas avoir le droit de modifier cette liste de contrôle. Si vous pensez qu\'il s\'agit d\'une erreur, contactez un administrateur';
