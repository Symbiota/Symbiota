...
$LANG['UPLOAD_METHOD'] = 'Método de carga';
...
$LANG['MAPPING_PROFILE'] = 'Perfil de mapeo';
...
$LANG['SELECT_ACTION'] = 'Subir acción';
$LANG['FILE_SELECT'] = 'Importación de archivos: actualizar solo los campos del archivo';
$LANG['FILE_FULL'] = 'Importación de archivos: reemplazar registro completo';
$LANG['MANUAL_DWCA'] = 'Importación manual de Darwin Core Archive';
$LANG['FILE_SKELETAL'] = 'Importación de archivos esqueléticos (solo campos vacíos)';
$LANG['IPT_DWCA'] = 'IPT Resource / Darwin Core Archive Provider';
$LANG['NFN_UPLOAD'] = 'Importación manual de Note from Nature (NfN)';
$LANG['SYMBIOTA_DWCA'] = 'Importación de Symbiota';
$LANG['DIRECT_DB'] = 'Transferencia directa de base de datos';
