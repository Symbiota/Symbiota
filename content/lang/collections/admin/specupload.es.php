...
$LANG['LIMIT_FIELDS'] = 'Actualizar solo campos en el archivo';
$LANG['SKELETAL_UPDATE'] = 'Actualización del esqueleto (solo campos vacíos)';
$LANG['REPLACE_FULL'] = 'Reemplazar registro completo';
