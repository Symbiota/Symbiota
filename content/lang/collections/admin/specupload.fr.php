...
$LANG['UPLOAD_METHOD'] = 'Méthode de téléchargement';
...
$LANG['MAPPING_PROFILE'] = 'Profil de mappage';
...
$LANG['SELECT_ACTION'] = 'Action de téléchargement';
$LANG['FILE_SELECT'] = 'Importation de fichiers - mettre à jour uniquement les champs du fichier';
$LANG['FILE_FULL'] = "Importation de fichier - remplacer l'enregistrement complet";
$LANG['MANUAL_DWCA'] = 'Importation du manuel des archives Darwin Core';
$LANG['FILE_SKELETAL'] = 'Importation de fichiers squelettiques (uniquement les champs vides)';
$LANG['IPT_DWCA'] = "Fournisseur de ressources IPT / d'archives Darwin Core";
$LANG['NFN_UPLOAD'] = 'Note from Nature (NfN) importation de fichiers';
$LANG['SYMBIOTA_DWCA'] = 'Importation du Symbiota';
$LANG['DIRECT_DB'] = 'Transfert direct de base de données';
