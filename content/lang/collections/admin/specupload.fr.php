...
$LANG['LIMIT_FIELDS'] = 'Mettre à jour uniquement les champs du fichier';
$LANG['SKELETAL_UPDATE'] = 'Mise à jour du squelette (uniquement les champs vides)';
$LANG['REPLACE_FULL'] = "Remplacer l'enregistrement complet";
