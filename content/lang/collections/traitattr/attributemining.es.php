...
$LANG['SEARCH_ALL_COLLECTION'] = 'Buscando en todas las colecciones';
$LANG['CLICK_DISPLAY_COLLEC_LIST'] = 'haga clic para mostrar la lista de colecciones';
...
$LANG['DWC_EXTENSION_FILE'] = ' Archivo de extensión DwC.';
$LANG['HARVESTING_FILTER'] = 'Filtro de recolección';
$LANG['OCC_TRAIT'] = 'Rasgo de ocurrencia:';
$LANG['SELECT_TARGET_TRAIT'] = 'Seleccionar rasgo objetivo (obligatorio)';
$LANG['NO_ATTRI_AVAILABLE'] = 'No hay atributos disponibles';
$LANG['VERBATIM_TEXT_SOURCE'] = 'Fuente del texto textual:';
$LANG['SELECT_SOURCE_FIELD'] = 'Seleccionar campo de origen (obligatorio)';
...
$LANG['NOTES'] = 'Notas:';
$LANG['STATUS'] = 'Estado: ';
$LANG['EXPERT NEEDED'] = 'Se necesita experto';
$LANG['BATCH_ASSIGN_STATE'] = 'Estados de asignación por lotes';
$LANG['RESET_FORM'] = 'Restablecer formulario';
$LANG['SELECT_COLLECTIONS'] = 'Seleccione las colecciones que desea codificar:';
$LANG['SELECT_DESELECT_ALL'] = 'Seleccionar/Deseleccionar todo';
$LANG['HARVEST_COLLECTIONS'] = 'Cosecha de colecciones';
