			...
			<div class="top-brand">
				<a href="<?= $CLIENT_ROOT ?>">
					<div class="image-container">
						<img src="<?= $CLIENT_ROOT ?>/images/layout/biodiversidad_logo.png" alt="Biodiversidad.gt logo">
					</div>
				</a>
				<div class="brand-name">
					<h1><?= $LANG['H_TITLE'] ?></h1><br>
					<h2><?= $LANG['H_SUBTITLE'] ?>
				</div>
			</div>
		</div>
				...
				<ul class="menu">
					...
					<li>
						...
						<ul>
							...
							<li>
								<a href="<?= $CLIENT_ROOT ?>/collections/search/index.php">
									<?= $LANG['H_COLLECTIONS'] ?>
								</a>
							</li>
							<li>
