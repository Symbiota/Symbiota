		...
		<td id="header" colspan="3">
			<div style="clear:both; width:100%; height:170px; border-bottom:1px solid #000000;">
				<div style="float:right;">
					<img src="<?php echo $CLIENT_ROOT; ?>/images/layout/AfricanHerbariaHeader.jpg" style="height:150px;" />
				</div>
			...
			<div id="top_navbar">
				...
				<ul id="hor_dropdown">
					...
					<li>
						...
						<ul>
							<li>
								<a href="<?php echo $CLIENT_ROOT; ?>/projects/index.php?pid=1" >Gabon Flora</a>
							</li>
							<li>
								<a href="<?php echo $CLIENT_ROOT; ?>/projects/index.php?pid=3" >Kenya</a>
							</li>
							<li>
								<a href="<?php echo $CLIENT_ROOT; ?>/projects/index.php?pid=2" >Tanzania</a>
							</li>
						</ul>
					</li>
					<li>
