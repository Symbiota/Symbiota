...
function addIdentifierField(clickedObj) {
  ...
  var insertHtml = '<div class="divTableRow"><div class="divTableCell"><input name="idkey[]" type="hidden" value="newidentifier" /><input class="idNameInput" name="idname[]" type="text" value="" onchange="fieldChanged(\'idname\');" autocomplete="off" aria-label="Tag Name (optional)"/></div><div class="divTableCell"><input class="idValueInput" name="idvalue[]" type="text" value="" onchange="fieldChanged(\'idvalue\');searchOtherCatalogNumbers(this.form);" autocomplete="off" aria-label="Additional Identifier Value"/><button class="seemore" onclick="addIdentifierField(this);return false" aria-label="Add Identifier Value and Tag Name pair"><img src="../../images/plus.png" style="width:1em; height:1em;" alt=""/></button></div></div>';
