				...
				<tr>
					<td colspan="2" valign="bottom">
						...
						<div id="scinameDiv">
							...
							echo '&nbsp;<a href="' . htmlspecialchars($parentLink, ENT_COMPAT | ENT_HTML401 | ENT_SUBSTITUTE) . '"><img class="navIcon" src="../images/toparent.png" style="height:1em" title="' . $LANG['GO_TO_PARENT'] . '" /></a>';
